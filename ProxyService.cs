...
namespace Proxy {
    internal class ProxyService {
        ...
        public ProxyService(string targetRedirectHost, int targetRedirectPort, int runPort) {
            ...
            SetEndPoint(new ExplicitProxyEndPoint(IPAddress.Any, runPort, true));
        }
        ...
        private void SetEndPoint(ExplicitProxyEndPoint explicitEP) {
            ...
            Console.WriteLine("Successfully proxy to server!");
        }
